...
class CustomWithLossCell(nn.Cell):
    ...
    def construct(self, data, label, second_label ,length, target, light, color, composition):
        ...
        return self._loss_fn( output_light, target)
...
if __name__ == "__main__":
    ...
    ava_train = mydataset.GetDatasetGenerator(data_path, lable_path, divide=divide, transforms=train_transforms,ranges=0.02, gtlabel="Light")
    ...
    ava_val = mydataset.GetDatasetGenerator(data_path, val_path, divide=divide, transforms=val_transforms,ranges=0.02, gtlabel="Light")
    ...
    param_class = load_checkpoint("./class/class.ckpt")
    ...
    for para in net.trainable_params():
      ...
      if para.name.split('.')[0] == 'regression_light1':
